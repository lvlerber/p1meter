...
// Arduino Due programming port => choose Serial
  ...
  #define CONSOLE Serial2      // Adafruit Grand Central M4  (LVL 26/11 mijn console via usb is niet betrouwbaar, dus sturen we dat via het wifi kanaal naar de esp32
                                // dit was oorspronkelijk Serial en is nu afgeleid naar Serial2
#elif __linux__ 
...
// ------ hardware pins---------------------------------------
// no configuration needed here
// pins 00-39 = ESP32 GPIO
// pins 40-55 = MCP23017 1
// pins 56-71 = mcp23017 2
// pins 72-76 = PCF8591 1
// pins 77-81 = PCF8591 2
...
#define MCP23017_2 0x00
#define PCF8591_1  0x48
#define PCF8591_2  0x4C

#define pinIrqExp 33              // Interrupts of all I/O expander boards

#define pinMotorEnable  40         // EN motors enable
#define pinMotorLeftPWM 2          // M1_IN1 left motor PWM pin  ESP32
#define pinMotorLeftDir 46         // M1_IN2 left motor Dir pin
#define pinMotorLeftSense 73       // M1_FB  left motor current sense
#define pinMotorLeftFault 51       // M1_SF  left motor fault
                                                             
#define pinMotorRightPWM  12       // M2_IN1 right motor PWM pin ESP32
#define pinMotorRightDir 47        // M2_IN2 right motor Dir pin
#define pinMotorRightSense 72      // M2_FB  right motor current sense
#define pinMotorRightFault 49      // M2_SF  right motor fault
                                    
#define pinMotorMowPWM 15          // M1_IN1 mower motor PWM pin (if using MOSFET, use this pin)   ESP32
#define pinMotorMowDir 44          // M1_IN2 mower motor Dir pin (if using MOSFET, keep unconnected)
#define pinMotorMowSense 75        // M1_FB  mower motor current sense  
#define pinMotorMowFault 50        // M1_SF  mower motor fault   (if using MOSFET/L298N, keep unconnected)
#define pinMotorMowEnable 43       // EN mower motor enable      (if using MOSFET/L298N, keep unconnected)
//#define pinMotorMowRpm A11  //unused
    
//#define pinFreeWheel 8             // front/rear free wheel sensor    
#define pinBumperLeft 53           // bumper pins
#define pinBumperRight 52

// #define pinDropLeft 45           // drop pins                                                                                          Dropsensor - Absturzsensor
// #define pinDropRight 23          // drop pins                                                                                          Dropsensor - Absturzsensor

#define pinSonarCenterTrigger 42   // ultrasonic sensor pins
#define pinSonarCenterEcho 35
#define pinSonarRightTrigger 45    
#define pinSonarRightEcho 27
#define pinSonarLeftTrigger 41         
#define pinSonarLeftEcho 34
// #define pinPerimeterRight A4       // perimeter
// #define pinDockingReflector A4     // docking IR reflector
// #define pinPerimeterLeft A5
...
#define pinBatterySwitch 4         // battery-OFF switch   
#define pinChargeVoltage 80        // charging voltage sensor
#define pinChargeCurrent 79        // charge current sensor
#define pinChargeRelay 81          // charge relay
// #define pinRemoteMow 12            // remote control mower motor
// #define pinRemoteSteer 11          // remote control steering 
// #define pinRemoteSpeed 10          // remote control speed
// #define pinRemoteSwitch 52         // remote control switch
...
#define pinOdometryLeft 54      // left odometry sensor
#define pinOdometryRight 55     // right odometry sensor 


#define pinGsmReset  5              // gsm reset
#define pinGsmRx  13
#define pinGsmTx  14
#define pinSdSclk  18
#define pinSdMiso  19
